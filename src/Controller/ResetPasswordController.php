...
class ResetPasswordController extends AbstractController
{
    ...
    public function __construct(ResetPasswordHelperInterface $resetPasswordHelper, EntityManagerInterface $entityManager, MailjetManager $mailjetManager)
    {
        $this->resetPasswordHelper = $resetPasswordHelper;
        $this->entityManager = $entityManager;
        $this->mailjetManager = $mailjetManager;
    }
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, TranslatorInterface $translator): RedirectResponse
    {
        ...
        $this->mailjetManager->send(
            $user->getEmail(),
            (string) $user,
            'Your password reset request',
            'To reset your password, please follow that link : <a href="'.$url.'">'.$url.'</a>'
        );
